...
fun FormCatatan(
    ...
    Column(
        ...
        Column {
            Text(text = stringResource(R.string.pilihan))
            listOf(stringResource(R.string.masuk), stringResource(R.string.izin), stringResource(R.string.alpha)).forEach { kelasOption ->
                Row(
